...
class RegisterPage extends BaseClass<RouterProps> {
    ...
    render() {
        return (
            <div className="RegisterPage anmateContent">
                <div className="loginBox">
                    ...
                    <div className="loginCont">
                        <div className="loginRight" onClick={() => { this.props.history.go(-1) }}>
                            <div className="rightBox">
                                <span className="icon iconfont icon-xinyonghu1"></span>
                                <span className="rightBoxFont">返回登录</span>
                            </div>
                        </div>
                        <div className="loginLeft">
                            <div className="leftCont">
                                {this.renderInput()}
                                <div className="regBtn" onClick={this.regist.bind(this)}>
                                    <span>注册</span>
                                </div>
                            </div>
    ...
    regist() {
        console.log(this.state.reqKeyList)
